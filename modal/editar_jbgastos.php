		  ...
		  <div class="modal-body">
			...
			<div id="resultados_ajax2"></div>
			 ...
			 <div class="form-group">
				<label for="factura2" class="col-sm-3 control-label">Factura</label>
				<div class="col-sm-8">
				  <input type="text" class="form-control" id="factura2" name="factura2" placeholder="Nº factura" >
				</div>
			  </div>
			<div class="form-group">
			  ...
			  <div class="form-group">
				<label for="concepto2" class="col-sm-3 control-label">Concepto</label>
				<div class="col-sm-8">
				<select class="form-control" id="concepto2"  name="concepto2" >
					<option selected disabled required value="0">Cambie el concepto</option>
