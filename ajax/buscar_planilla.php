			...
			<div class="table-responsive">
			  <table class="table">
				...
				while ($row=mysqli_fetch_array($query)){
					...
					<td class="text-right">
						<a href="editar_planilla.php?id_planilla=<?php echo $id_planilla;?>" class='btn btn-success' title='Editar Planilla' ><i class="glyphicon glyphicon-edit"></i></a> 
